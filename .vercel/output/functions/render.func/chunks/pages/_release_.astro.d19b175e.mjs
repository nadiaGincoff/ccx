/* empty css                               */import { _ as __astro_tag_component__, c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, d as renderHead, e as renderComponent, f as renderSlot, m as maybeRenderHead } from '../astro.1d7f3216.mjs';
import 'html-escaper';
...
}, "/home/nadiaginc/projects/practice-projects/astro/ccx/src/layouts/Layout.astro", void 0);
...
const $$release = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<main class="m-auto p-4 h-full flex flex-col justify-center items-center">
    ...
    <div class="w-full md:px-10 bg-black">
      <iframe id="soundcloud" width="100%" height="166" scrolling="yes" frameborder="no" allow="autoplay"${addAttribute(`https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/${info.soundcloudId}&amp;color=84D290&show_artwork=false&single_active=false`, "src")}>
      </iframe>
    </div>
  </main>
` })}`;
}, "/home/nadiaginc/projects/practice-projects/astro/ccx/src/pages/[release].astro", void 0);
